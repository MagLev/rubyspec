...
# Maglev, line numbers vary , see 23 in MRI parser, 24 in RubyParser
#  it "includes the line number of the location where self raised in the first element" do
#    @backtrace.first.should =~ /.*:23: in/ # Maglev, was  /:22:in /
#  end
...
# Maglev confused by frames in blocks and absolute paths, etc 
