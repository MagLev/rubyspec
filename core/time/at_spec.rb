...
#       Time.at(1184027924).inspect.chomp.should == localtime_18(1184027924).chomp # EPERM on localtime
        Time.at(1168475924).inspect.chomp.should == 'Wed Jan 10 16:38:44 -0800 2007'  # Maglev
      end
    end
